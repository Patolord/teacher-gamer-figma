...
export default function CalendarBookingSection({
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="bg-[linear-gradient(135deg,#D29E2D_16%,#E0C07B_37%,#E0C07B_60%,#D29E2D_100%)] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradientShift text-3xl text-center font-pirata-one">
          Agende sua Sessão
        </h2>
