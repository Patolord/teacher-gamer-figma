...
export default function SubstackSection({ sectionIndex }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-4xl pb-8 bg-[linear-gradient(135deg,#D29E2D_16%,#E0C07B_37%,#E0C07B_60%,#D29E2D_100%)] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradientShift">Latest from Substack</h2>
