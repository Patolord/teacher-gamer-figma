...
export default function ContactSection({ sectionIndex }: ContactSectionProps) {
  return (
    ...
    >
      ...
      >
        <h2 className="text-6xl font-bold bg-[linear-gradient(135deg,#D29E2D_16%,#E0C07B_37%,#E0C07B_60%,#D29E2D_100%)] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradientShift mb-8 text-center max-[1000px]:text-4xl font-aladin">
          Get In Touch
        </h2>
